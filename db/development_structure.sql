...
CREATE TABLE "course_topic_relations" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "activated_topic_id" integer NOT NULL, "course_starting_year_id" integer NOT NULL, "teaching_typology" varchar(2) DEFAULT 'C' NOT NULL, "mandatory_flag" boolean DEFAULT 't' NOT NULL, "course_year" integer NOT NULL);
...
INSERT INTO schema_migrations (version) VALUES ('20111009033713');